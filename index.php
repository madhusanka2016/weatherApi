...
for ($month = 1; $month <= 12; $month++){
  for ($x = 1; $x <= 31; $x++){
    $FileContents = file_get_contents("https://www.yr.no/place/Norway/Oppland/Dovre/Domb%C3%A5s_observation_site/almanakk.html?dato=".$year."-".$month."-".$x);
    //sleep(1);
    $filename=$year."-".$month."-".$x.".php";
    $fp = fopen($filename, 'a');
