...
for($sumday = 0; $sumday <$cnt; $sumday++){
    ...
    $sql = "INSERT INTO `weathersum_flam`(`date`, `city`, `maxtempC`, `mintempC`, `avgtempC`, `totalSnow_cm`, `sunHour`, `uvIndex`) VALUES ('$date','$city','$maxtempC','$mintempC','$avgtempC','$totalSnow_cm','$sunHour','$uvIndex')";
